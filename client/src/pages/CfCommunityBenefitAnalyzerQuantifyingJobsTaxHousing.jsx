...
export default function CfCommunityBenefitAnalyzerQuantifyingJobsTaxHousing() {
  ...
  const submit = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/cf-community-benefit-analyzer-quantifying-jobs-tax-housing-impact/run`, {
        method: 'POST', headers: getHeaders(),
        body: JSON.stringify({ prompt: input, feature: 'cf-community-benefit-analyzer-quantifying-jobs-tax-housing-impact', project: 'AIUrbanPlanningZoningSimulator' })
      })
  ...
  const loadHistory = async () => {
    try {
      const res = await fetch(`${API_BASE}/api/cf-community-benefit-analyzer-quantifying-jobs-tax-housing-impact/history`, { headers: getHeaders() })
      const data = await res.json()
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-slate-800">Community benefit analyzer quantifying jobs/tax/housing impact</h1>
